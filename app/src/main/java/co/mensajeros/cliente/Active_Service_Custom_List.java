...
public class Active_Service_Custom_List extends ArrayAdapter<TaskObject> {
    ...
    public Active_Service_Custom_List(Activity context, ArrayList<TaskObject> objects) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView= inflater.inflate(R.layout.active_service_item, null, true);
