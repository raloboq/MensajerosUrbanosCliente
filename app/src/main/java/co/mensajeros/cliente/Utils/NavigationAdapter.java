...
//import br.liveo.navigationviewpagerliveo.NavigationMain;
import co.mensajeros.cliente.R;
import co.mensajeros.cliente.MainActivityPager;
        ...
        if (item != null && holder != null) {
            ...
            if (holder.counter != null) {
                if (item.counter > 0) {
                    ...
                    int counter = ((MainActivityPager)getContext()).getCounterItemDownloads();
